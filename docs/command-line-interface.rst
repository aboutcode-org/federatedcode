...
:guilabel:`input/` directory::
    ...
    $ scanpipe add-input --project foo --input-url https://github.com/nexB/federatedcode-tutorial/releases/download/sample-images/30-alpine-nickolashkraus-staticbox-latest.tar
...
.. note:: This command is to be used when FederatedCode's authentication system
  :ref:`federatedcode_settings_require_authentication` is enabled.
