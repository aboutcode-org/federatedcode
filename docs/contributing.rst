...
`README <https://github.com/nexB/federatedcode#readme>`_, read through our
`documentation <https://federatedcode.readthedocs.io/en/latest/>`_,
and browse existing `issues <https://github.com/nexB/federatedcode/issues>`_,
...
`good first issues <https://github.com/nexB/federatedcode/labels/good%20first%20issue>`_
...
- Report a new `bug <https://github.com/nexB/federatedcode/issues>`_; just remember to be
  as specific as possible.
- Create a `new issue <https://github.com/nexB/federatedcode/issues>`_ to request a
  feature, submit a feedback, or ask a question.
- Look into existing `bugs <https://github.com/nexB/federatedcode/labels/bug>`_,
  try to reproduce the issue on your side, and discuss solutions in the comments.

.. note::
    Make sure to check existing `issues <https://github.com/nexB/federatedcode/issues>`_,
...
When there is no existing issues, start by `creating one <https://github.com/nexB/federatedcode/issues>`_
...
3. **Commit messages and Developer Certificate of Origin**
  ...
  and `check some examples <https://github.com/nexB/federatedcode/commits/main>`_.
