...
Contributing to FederatedCode
==============================

Thank you so much for being so interested in contributing to FederatedCode. We
...
.. note::
    By contributing to the FederatedCode project, you agree to the Developer
...
`README <https://github.com/aboutcode-org/federatedcode#readme>`_, read through our
`documentation <https://federatedcode.readthedocs.io/en/latest/>`_,
and browse existing `issues <https://github.com/aboutcode-org/federatedcode/issues>`_,
...
Contributing to the codebase is not the only way to add value to FederatedCode or
...
`good first issues <https://github.com/aboutcode-org/federatedcode/labels/good%20first%20issue>`_
...
- Report a new `bug <https://github.com/aboutcode-org/federatedcode/issues>`_; just remember to be
  as specific as possible.
- Create a `new issue <https://github.com/aboutcode-org/federatedcode/issues>`_ to request a
  feature, submit a feedback, or ask a question.
- Look into existing `bugs <https://github.com/aboutcode-org/federatedcode/labels/bug>`_,
  try to reproduce the issue on your side, and discuss solutions in the comments.

.. note::
    Make sure to check existing `issues <https://github.com/aboutcode-org/federatedcode/issues>`_,
...
When there is no existing issues, start by `creating one <https://github.com/aboutcode-org/federatedcode/issues>`_
...
3. **Commit messages and Developer Certificate of Origin**
  ...
  and `check some examples <https://github.com/aboutcode-org/federatedcode/commits/main>`_.
...
`FederatedCode documentation <https://federatedcode.readthedocs.io/en/latest/>`_.
...
You want to contribute to other aspects of the FederatedCode project, and you
